/******** End header after scrollback ************/     
      ...
      function checkerror(){
        var getleng = jQuery('.wpcf7-form-control-wrap').length;
        for(i=0;i<getleng;i++){
            var geterrorleng = jQuery('.wpcf7-form-control-wrap:eq('+i+') .wpcf7-not-valid-tip').length;
            if(geterrorleng > 1){
                jQuery('.wpcf7-form-control-wrap:eq('+i+') .wpcf7-not-valid-tip + .wpcf7-not-valid-tip').remove();
            }
        }
